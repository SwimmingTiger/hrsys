...
<div style="font-size: 16px;font-family: Microsoft YaHei, 宋体, Segoe UI, verdana, arial;color: #fefefe">对试用期员工的信息进行维护</div>
</td>
...
<td width="944">
		...
		<legend style="font-family: '宋体';color:#007BBB ">试用期信息</legend>
			<form method="post" action="EmployeeServlet?flag=search_probation">
